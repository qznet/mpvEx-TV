...
internal object Utils {
    // Versions 鈥?queried from native libraries at init time
    object VERSIONS {
        var mpv: String = "unknown"
        var ffmpeg: String = "unknown"
        var libPlacebo: String = "unknown"
    }
    ...
    /**
     * Helper class that keeps much more state than AudioMetadata, in order to facilitate
            ...
            return with (mediaMetadataBuilder) {
                ...
                if (includeThumb) {
                    putBitmap(MediaMetadataCompat.METADATA_KEY_ART,
                        null  // thumbnail not available in this build
                    )
                }
    ...
    // This is used to filter files in the file picker
